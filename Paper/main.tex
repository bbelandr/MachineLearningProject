...
Our \texttt{elapsed\_time\_z} feature details the z-score of a student's time taken to answer a question relative to their previous time taken. To avoid temporal leakage, we compute this as a rolling value, smoothed with Bayesian smoothing using \texttt{$\alpha$=20}. This ensures that early interactions will not heavily skew the rolling data.
