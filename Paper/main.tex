...
Alex Ogle collaborated closely with Will on feature selection and designing the model. Additionally, Alex contributed detail by developing graphs of the data to support the chosen normalization method.

Will Sessoms focused on feature extraction and was responsible for creating the \texttt{prep\_data.ipynb} notebook used for dataset consolidation. Will also worked specifically on developing our preprocessing pipeline.
