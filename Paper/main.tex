...
Dataset description goes here. If you could use specific numbers about how large the dataset is that'd be really cool. Could also mention that most of the data isn't useful to the model at base, so the majority of the project is focused on feature engineering.
